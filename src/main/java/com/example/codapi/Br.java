...
public class Br {
     ...
     * @param deaths
     */
    public Br(Integer wins, Integer kills, Double kdRatio, Integer downs, Integer topTwentyFive, Integer objTime, Integer topTen, Integer contracts, Integer revives, Integer topFive, Integer score, Integer timePlayed, Integer gamesPlayed, Integer tokens, Double scorePerMinute, Integer cash, Integer deaths) {
        super();
        this.wins = wins;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Br.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("wins");
        sb.append('=');
