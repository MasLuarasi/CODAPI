...
public class EquipGasGrenade {
     ...
     * @param uses
     */
    public EquipGasGrenade(Integer extraStat1, Integer uses) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EquipGasGrenade.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
