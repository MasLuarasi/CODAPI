...
public class All__1 {
     ...
     * @param damageTaken
     */
    public All__1(Integer kills, Integer medalXp, Integer matchXp, Double averageSpeedDuringMatch, Integer scoreXp, Double accuracy, Integer losses, Integer wallBangs, Double avgLifeTime, Integer shotsLanded, Integer score, Integer totalXp, Integer headshots, Integer assists, Integer draws, Integer rank, Double scorePerMinute, Double distanceTraveled, Integer deaths, Integer wins, Double kdRatio, Integer shotsMissed, Double scorePerGame, Integer timePlayed, Double headshotPercentage, Integer executions, Integer matchesPlayed, Integer suicides, Integer seasonRank, Double wlRatio, Integer nearmisses, Double percentTimeMoving, Integer miscXp, Integer longestStreak, Integer damageDone, Integer shotsFired, Integer damageTaken) {
        super();
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(All__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
