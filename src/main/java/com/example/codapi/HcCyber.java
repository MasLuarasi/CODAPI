...
public class HcCyber {
     ...
     * @param deaths
     */
    public HcCyber(Integer kills, Integer score, Integer timePlayed, Integer kdRatio, Integer plants, Integer scorePerMinute, Integer revives, Integer deaths) {
        super();
        this.kills = kills;
        this.score = score;
    ...
    public String toString() {
        ...
        sb.append(HcCyber.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
