...
public class PrecisionAirstrike {
     ...
     * @param awardedCount
     */
    public PrecisionAirstrike(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(PrecisionAirstrike.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
