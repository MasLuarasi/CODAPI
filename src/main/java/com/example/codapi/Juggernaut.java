...
public class Juggernaut {
     ...
     * @param awardedCount
     */
    public Juggernaut(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(Juggernaut.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
