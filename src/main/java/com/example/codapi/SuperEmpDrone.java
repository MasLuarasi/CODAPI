...
public class SuperEmpDrone {
     ...
     * @param uses
     */
    public SuperEmpDrone(Integer kills, Integer misc1, Integer misc2, Integer uses) {
        super();
        this.kills = kills;
        this.misc1 = misc1;
        this.misc2 = misc2;
    ...
    public String toString() {
        ...
        sb.append(SuperEmpDrone.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
