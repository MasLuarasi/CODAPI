...
public class CruisePredator {
     ...
     * @param awardedCount
     */
    public CruisePredator(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(CruisePredator.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
