...
public class EquipSmoke {
     ...
     * @param uses
     */
    public EquipSmoke(Integer extraStat1, Integer uses) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EquipSmoke.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
