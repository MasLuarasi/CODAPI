...
public class Iw8MeRiotshield {
     ...
     * @param deaths
     */
    public Iw8MeRiotshield(Integer hits, Integer kills, Double kdRatio, Integer headshots, Integer accuracy, Integer shots, Integer deaths) {
        super();
        this.hits = hits;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Iw8MeRiotshield.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("hits");
        sb.append('=');
