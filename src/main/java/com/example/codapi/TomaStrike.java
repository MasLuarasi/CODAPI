...
public class TomaStrike {
     ...
     * @param awardedCount
     */
    public TomaStrike(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(TomaStrike.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
