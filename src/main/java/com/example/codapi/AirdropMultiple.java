...
public class AirdropMultiple {
     ...
     * @param awardedCount
     */
    public AirdropMultiple(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(AirdropMultiple.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
