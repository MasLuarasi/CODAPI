...
public class HcConf {
     ...
     * @param deaths
     */
    public HcConf(Integer kills, Integer score, Integer timePlayed, Double kdRatio, Integer confirms, Double scorePerMinute, Integer denies, Integer deaths) {
        super();
        this.kills = kills;
        this.score = score;
    ...
    public String toString() {
        ...
        sb.append(HcConf.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
