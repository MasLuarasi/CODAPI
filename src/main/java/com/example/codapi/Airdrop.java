...
public class Airdrop {
     ...
     * @param awardedCount
     */
    public Airdrop(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(Airdrop.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
