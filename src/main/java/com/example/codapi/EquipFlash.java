...
public class EquipFlash {
     ...
     * @param uses
     */
    public EquipFlash(Integer extraStat1, Integer uses) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EquipFlash.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
