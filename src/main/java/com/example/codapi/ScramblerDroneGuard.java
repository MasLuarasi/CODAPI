...
public class ScramblerDroneGuard {
     ...
     * @param awardedCount
     */
    public ScramblerDroneGuard(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(ScramblerDroneGuard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
