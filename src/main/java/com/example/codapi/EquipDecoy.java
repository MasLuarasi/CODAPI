...
public class EquipDecoy {
     ...
     * @param uses
     */
    public EquipDecoy(Integer extraStat1, Integer uses) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EquipDecoy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
