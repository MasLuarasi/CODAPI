...
public class HoverJet {
     ...
     * @param awardedCount
     */
    public HoverJet(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(HoverJet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
