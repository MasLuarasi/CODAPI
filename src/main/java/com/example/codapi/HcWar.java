...
public class HcWar {
     ...
     * @param deaths
     */
    public HcWar(Integer kills, Integer score, Integer timePlayed, Double kdRatio, Integer assists, Double scorePerMinute, Integer deaths) {
        super();
        this.kills = kills;
        this.score = score;
    ...
    public String toString() {
        ...
        sb.append(HcWar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
