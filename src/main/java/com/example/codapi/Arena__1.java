...
public class Arena__1 {
     ...
     * @param damageTaken
     */
    public Arena__1(Integer kills, Integer medalXp, Integer matchXp, Double averageSpeedDuringMatch, Integer scoreXp, Double accuracy, Integer wallBangs, Integer losses, Double avgLifeTime, Integer shotsLanded, Integer score, Integer totalXp, Integer headshots, Integer assists, Integer rank, Integer draws, Double scorePerMinute, Double distanceTraveled, Integer deaths, Integer wins, Double kdRatio, Integer shotsMissed, Double scorePerGame, Integer timePlayed, Double headshotPercentage, Integer matchesPlayed, Integer executions, Integer suicides, Integer seasonRank, Double wlRatio, Integer nearmisses, Double percentTimeMoving, Integer miscXp, Integer longestStreak, Integer damageDone, Integer shotsFired, Integer damageTaken) {
        super();
        this.kills = kills;
