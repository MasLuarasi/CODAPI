...
public class Iw8LaMike32 {
     ...
     * @param deaths
     */
    public Iw8LaMike32(Integer hits, Integer kills, Integer kdRatio, Integer headshots, Integer accuracy, Integer shots, Integer deaths) {
        super();
        this.hits = hits;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Iw8LaMike32 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("hits");
        sb.append('=');
