...
public class BrAll {
     ...
     * @param deaths
     */
    public BrAll(Integer wins, Integer kills, Double kdRatio, Integer downs, Integer topTwentyFive, Integer objTime, Integer topTen, Integer contracts, Integer revives, Integer topFive, Integer score, Integer timePlayed, Integer gamesPlayed, Integer tokens, Double scorePerMinute, Integer cash, Integer deaths) {
        super();
        this.wins = wins;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(BrAll.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("wins");
        sb.append('=');
