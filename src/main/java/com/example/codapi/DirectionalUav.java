...
public class DirectionalUav {
     ...
     * @param awardedCount
     */
    public DirectionalUav(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DirectionalUav.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
