...
public class Gunship {
     ...
     * @param awardedCount
     */
    public Gunship(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(Gunship.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
