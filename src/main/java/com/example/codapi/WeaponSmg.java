...
public class WeaponSmg {
    ...
    public WeaponSmg(Iw8SmMpapa7 iw8SmMpapa7, Iw8SmAugolf iw8SmAugolf, Iw8SmPapa90 iw8SmPapa90,
                     Iw8SmCharlie9 iw8SmCharlie9, Iw8SmMpapa5 iw8SmMpapa5, Iw8SmSmgolf45 iw8SmSmgolf45,
                     Iw8SmBeta iw8SmBeta, Iw8SmVictor iw8SmVictor, Iw8SmUzulu iw8SmUzulu)
    {
        super();
    ...
    @JsonAnyGetter
    public ArrayList<Object> getSmgList(){return this.smgList;}

    @JsonAnySetter
    public void setSmgList(ArrayList<Object> list){this.smgList = list;}
