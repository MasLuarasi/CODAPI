...
public class Iw8SnCrossbow {
     ...
     * @param deaths
     */
    public Iw8SnCrossbow(Integer hits, Integer kills, Double kdRatio, Integer headshots, Double accuracy, Integer shots, Integer deaths) {
        super();
        this.hits = hits;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Iw8SnCrossbow.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("hits");
        sb.append('=');
