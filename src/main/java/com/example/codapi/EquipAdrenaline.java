...
public class EquipAdrenaline {
     ...
     * @param uses
     */
    public EquipAdrenaline(Integer extraStat1, Integer uses) {
        super();
    ...
    public String toString() {
        ...
        sb.append(EquipAdrenaline.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
