...
public class Grnd {
     ...
     * @param deaths
     */
    public Grnd(Integer kills, Integer score, Integer timePlayed, Integer kdRatio, Integer defends, Integer objTime, Integer scorePerMinute, Integer deaths) {
        super();
        this.kills = kills;
        this.score = score;
    ...
    public String toString() {
        ...
        sb.append(Grnd.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kills");
        sb.append('=');
