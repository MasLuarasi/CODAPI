...
public class WhitePhosphorus {
     ...
     * @param awardedCount
     */
    public WhitePhosphorus(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(WhitePhosphorus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
