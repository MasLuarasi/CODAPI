...
public class Iw8MeAkimboblunt {
     ...
     * @param deaths
     */
    public Iw8MeAkimboblunt(Integer hits, Integer kills, Integer kdRatio, Integer headshots, Integer accuracy, Integer shots, Integer deaths) {
        super();
        this.hits = hits;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Iw8MeAkimboblunt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("hits");
        sb.append('=');
