...
public class Iw8MeAkimboblades {
     ...
     * @param deaths
     */
    public Iw8MeAkimboblades(Integer hits, Integer kills, Integer kdRatio, Integer headshots, Integer accuracy, Integer shots, Integer deaths) {
        super();
        this.hits = hits;
        this.kills = kills;
    ...
    public String toString() {
        ...
        sb.append(Iw8MeAkimboblades.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("hits");
        sb.append('=');
