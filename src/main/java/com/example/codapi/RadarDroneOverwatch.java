...
public class RadarDroneOverwatch {
     ...
     * @param awardedCount
     */
    public RadarDroneOverwatch(Integer extraStat1, Integer uses, Integer awardedCount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(RadarDroneOverwatch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
